...
<html lang="en">
    ...
    <body>
        ...
        <ul class="flex">
            ...
            <li class="flex-1 mr-2">
                <a class="text-center block border border-green-500 rounded py-2 px-4 bg-green-500 hover:bg-yellow-500 text-white" href="/about">Over ons</a>
            </li>

            <li class="flex-1 mr-2">
                <a class="text-center block border border-green-500 rounded py-2 px-4 bg-green-500 hover:bg-yellow-500 text-white" href="/contact">Contact</a>
            </li>

            <li class="flex-1 mr-2">
                <a class="text-center block border border-green-500 rounded py-2 px-4 bg-green-500 hover:bg-yellow-500 text-white" href="/login">Inloggen</a>
            </li>
        </ul>
